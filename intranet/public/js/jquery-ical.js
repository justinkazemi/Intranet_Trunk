...
(function($){
    ...
    $.fn.ical = function(options){
        $.fn.ical.defaults = {
           daynames: ['M', 'T', 'W', 'Th', 'F', 'S', 'Sn'], //default short names for the days of the week
        ...
        */
        function createNavigation(obj, insdate){
            ...
            obj.prepend("<div id='nav-calendar'>" + "<div id='month'><span id='month-left-arrow'></span><span id='currentmonth'>"+ options.monthnames[insdate.getMonth()] +"</span> " + "<span id='currentyear'>"+ insdate.getFullYear() +"</span><span id='month-right-arrow'></span></div></div>");
